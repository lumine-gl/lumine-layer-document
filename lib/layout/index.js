(function(){
  ...
  function Layout(LDoc, lumine, canvas){

    this._lDoc = LDoc;

    this._layoutGeometry = new LayoutGeometry(LDoc);
    this._layoutContent = new LayoutContent(LDoc, lumine, canvas);
  ...
  Layout.prototype.updateScroll = function(){
    return this._layoutContent.updateScroll.apply(this._layoutContent, arguments);
  };
